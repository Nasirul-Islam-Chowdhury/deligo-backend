...
const loginUser = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
      ...
      refreshToken,
      needsPasswordChange:
        user === null || user === void 0 ? void 0 : user.needsPasswordChange,
...
const changePassword = (userData, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.User.findById(userData.userId).select(
      "+password"
    );
    if (!user) {
      throw new ApiError_1.default(
...
const forgetPassword = (email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetToken = jwtHelpers_1.jwtHelpers.createToken(
      jwtPayload,
      config_1.default.jwt.secret,
