...
const loginUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.default)(res, {
        ...
        data: {
            ...
            needPasswordChange: (_a = result.needPasswordChange) !== null && _a !== void 0 ? _a : result.needsPasswordChange,
            // include both keys for compatibility with different clients
            needsPasswordChange: (_b = result.needsPasswordChange) !== null && _b !== void 0 ? _b : result.needPasswordChange,
            role: result.role,
        },
    });
}));
...
const forgotPass = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield auth_service_1.AuthServices.forgetPassword(req.body.email);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
